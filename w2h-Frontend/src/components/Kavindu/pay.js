        ...
        <div className="body1">
          <div className="info">
            <form className="form12">
              <h2 style={{ color: "blue" }}>Gold Member Paln</h2>
              <img
                src="https://purepng.com/public/uploads/large/purepng.com-gold-coinsgoldatomic-number-79chemical-elementgroup-11-elementaurumgold-dustprecious-metalgold-coins-1701528978267zsaly.png"
                width="150"
                height="150"
              ></img>
              <h2>2$ Daily Subscribe Paln</h2>
