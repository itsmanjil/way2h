        ...
        <div className="col-xl-4">
            ...
            <div className="card mb-4 mb-xl-0">
                ...
                <div className="card-body text-center">
                    ...
                    <button className="btn btn-primary" type="button" >Reward Point: {this.state.View.reward}</button>
                ...
                <div className="card-body">
                    <form >
                        ...
                        <div className="mb-3">
                            ...
                            <input className="inputabc" id="Email" type="text" disabled="disabled" value={this.state.View.Name}
