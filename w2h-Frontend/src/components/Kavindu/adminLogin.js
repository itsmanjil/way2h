...
export default function Admin() {
  ...
  const handleSubmit = (event) => {
    ...
    if (userHasRole('admin')) {
      ...
      alert('You do not have permission to log in as an admin');
    }
  };
    ...
    <div className="body1">
      <div className="info">
        <form className="form12" onSubmit={handleSubmit}>
          ...
          <input className="inputabc" type="text" placeholder="Username" id="user1" />
          <input className="inputabc" type="password" placeholder="Password" id="pass1" />
