...
export default class PayForRoom extends Component {
    ...
    axios.get(`http://localhost:8070/hotelpackage/read/${id}`).then((res) => {
      if (res.data.success) {
        this.setState({
          ...
          img: res.data.HotelPackage.packageImage,
  ...
  render() {
    ...
    const { roomType, price, method, img, size, payf } = this.state;
    return (
      <div>
        <Header />
        <div className="info">
              ...
              <div class="row" >
                ...
                <div class="col-md-5" >
                  <div class="righta border" style={{ backgroundColor: "white", borderRadius: "10px" }}>
                    ...
                    <div class="text-center mb-2"> <h2>Your Resrevation Details</h2> </div>
                    <hr class="text-center mb-4" />
                    <h4 style={{ color: "hsl(0,0%,0%,0.6)" }}>{roomType}</h4>
                    <div >
                    ...
                    <hr />
                    <div class="row lower">
                      <div class="col text-lefta">Size</div>
                      <div class="col text-righta">{size}</div>
                    </div>
                    <hr />
                    <div class="row lower">
                    ...
                    <form onSubmit={this.onSubmit}>
                      ...
                      <div class="row mb-2" >
                        <div class="col">
                          ...
                          <div class="input-group mb-3">
                            ...
                            <input type="text" className="form-control" name="reference" value={roomType} onChange={this.onChangeReference} disabled />
                          </div></div>
                      ...
                      <div class="d-flex flex-row align-items-center mb-3">
                        ...
                        <div class="form-outline mb-2 col-7">
                          <input type="text" className="form-control" name="payf" value="Hotel Package" onChange={this.onChangePay} disabled />
                      ...
                      <div class="d-flex flex-row align-items-center mb-4">
                        ...
                        <div class="form-outline mb-2 col-9">
                          <input
                            ...
                            value={this.state.card} onChange={this.onChangeCard} maxLength="16" required="required"
                          /></div>
