...
export default class PayForActivity extends Component {
  ...
  render() {
    const { activityName, price, payf, method, img, category } = this.state;
    return (
      <div>
        <Header />
        <div className="info">
                ...
                <div class="col-md-5">
                  ...
                  >
                    <div class="text-center mb-2">
                      {" "}
                      <h2>Your Selected Activity</h2>{" "}
                    </div>
                    <hr class="text-center mb-4" />
                    <h4 style={{ color: "hsl(0,0%,0%,0.6)" }}>
                      {activityName}
                    </h4>
                    <div>
                      <div class="col-12 ">
                    ...
                    <hr />
                    <div class="row lower">
                      <div class="col text-lefta">Category</div>
                      <div class="col text-righta">{category}</div>
                    </div>
                    <hr />
                    <div class="row lower">
