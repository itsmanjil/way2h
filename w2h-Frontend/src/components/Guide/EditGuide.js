...
const EditGuide = () => {
  ...
  const onSubmit = async (e) => {
    ...
    // Validation checks
    if (address === "" || language === "" || email === "" || phone === "") {
      ...
      <div className="infoadmin">
        <section id="edit">
          <div className="container" style={{ background: "blueviolet" }}>
            <br />
            <div
              className="w-50 mx-auto shadow p-5"
            ...
            >
              ...
              <form onSubmit={(e) => onSubmit(e)}>
                ...
                >
                  <i class="fa fa-user-o mr-2" aria-hidden="true" />
                  <strong>Name</strong>
                </label>
                ...
                <label
                  ...
                  style={{ fontSize: 17, color: "green" }}
                >
                  <i class="fa fa-pencil-square-o mr-2" aria-hidden="true" />
                ...
                <label
                  ...
                  style={{ fontSize: 17, color: "green" }}
                >
                  <i class="fa fa-address-book-o mr-2" aria-hidden="true" />
