...
export default class PackageDetails extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <Header />
        <Pageheader headertitle="PackageDetails" />
        {/* <AddRating id={_id}/> */}
        <div className="ltn__shop-details-area pb-10">
				...
				<div className="row">
					...
					<div className="ltn__shop-details-inner ltn__page-details-inner mb-60">
						...
						<h1>{packageName}</h1>
						<label><span className="ltn__secondary-color"><i className="flaticon-pin" /></span>{destination}</label>
						...
						<h4 className="title-2">Package Contains</h4>  
						...
						{/* comment-reply */}
            <button onClick={this.post_comment}>Click</button>
                 ...
                 >Submit</button>
					...
					<aside className="sidebar ltn__shop-sidebar ltn__right-sidebar---">
						...
						<div className="ltn__author-widget-inner text-center">
							...
							<ul>
								<li><a href={`/bookingpackage/${_id}`} title="Facebook"><i className="fab fa-facebook-f" /></a></li>
						...
						{/* <form action="#"> */}
							...
							<a href={`/bookingpackage/${_id}`} type="submit" className="btn theme-btn-1">Want To Book?</a>
						{/* </form> */}
						</div>
